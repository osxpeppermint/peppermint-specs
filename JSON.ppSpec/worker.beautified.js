...
(function(e) {
    ...
    var r, i, s = {
        ...
        return e && e !== i && u("Expected '" + e + "' instead of '" + i + "'"), i = o.charAt(r), 
        r += 1, i;
    }, f = function() {
        var e, t = "";
        i === "-" && (t = "-", a("-"));
        ...
        if (i === "{") {
            ...
            if (i === "}") return a("}"), t;
            while (i) {
                e = l(), c(), a(":"), Object.hasOwnProperty.call(t, e) && u('Duplicate key "' + e + '"'), 
                t[e] = p(), c();
                if (i === "}") return a("}"), t;
                a(","), c();
            }
    ...
    return p = function() {
        ...
        return o = e, r = 0, i = " ", n = p(), c(), i && u("Syntax error"), typeof t == "function" ? function s(e, n) {
            var r, i, o = e[n];
            if (o && typeof o == "object") for (r in o) Object.hasOwnProperty.call(o, r) && (i = s(o, r), 
